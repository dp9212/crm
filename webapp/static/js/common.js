//关联对象显示名称
function objectFormatter(v){
	return v?v.name || v.realName || v.text || v.title || '':'';
}
//关联对象显示名称--日志专用
function objectFormatterLog(v){
	return v?v.name || v.realName || v.text || v.title || "":"<font color='#0000FF'>登录操作</font>";
}
//专门用来处理状态
function stateFormatter(value, row, index) {
	return value == 0 ? "正常" : "<font color='red'>离职</font>";
}


//扩展用于序列化表单请求参数为json格式
