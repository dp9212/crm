...
public class JXLExcelView extends AbstractJExcelView {  
    ...
    private String[] columnNames = new String[] { "编号", "姓名", "年龄", "性别", "邮箱",  
            "地址","收入","营销人员" };  
  
    private String[] dbColumnNames = new String[] { "id", "name", "age", "gender",  
            "email", "address", "salaryLevel","seller"};  
  
    private Integer[] columnWidths = new Integer[] { 10, 20, 10, 10, 20, 20,20,20,20 };  
        ...
        try {  
            for (int i = 0; i < rows; i++) {  
                ...
                for (int j = 0; j < cols; j++) {  
                    ...
                    if(columnName=="salaryLevel"){
                    	 value = ((SystemDictionaryItem)PropertyUtils.getProperty(t, columnName)).getName(); 
                    }else if(columnName=="seller"){
                    	value = ((Employee)PropertyUtils.getProperty(t, columnName)).getRealName(); 
